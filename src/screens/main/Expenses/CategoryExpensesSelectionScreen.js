    ...
    return(
        <SafeAreaView style={{flex:1, backgroundColor:'#fffffa'}}>
            <View style={{flex:1, paddingBottom:20}}>
                ...
                <Text style={{fontFamily:'ZenOldMincho-Regular',fontSize:24, color:'#ffffff'}}>ค่าใช้จ่าย</Text>
            ...
            <View style={{flex:9, padding:5}}>
                    ...
                    <Shadow style={{width:'100%', height:'100%'}} distance={7} startColor={"#0ABAB5"} offset={[8,6]}>
                        <View style={styles.box}>
                            <View style={styles.boxhead}>
                                <Text style={styles.headerText}>ค่าใช้จ่ายผันแปร</Text>
                            </View>
                            <View style={{flex:3}}>
                                <FlatList
                                    data={category1}
                ...
                <View style={{flex:3, marginVertical:10}}>
                    <Shadow style={{width:'100%', height:'100%'}} distance={7} startColor={"#0ABAB5"} offset={[8,6]}>
                        <View style={styles.box}>
                            <View style={styles.boxhead}>
                                <Text style={styles.headerText}>ค่าใช้จ่ายคงที่</Text>
                            </View>
                            <View style={{flex:3}}>
                                <FlatList
                                    data={category2}
                ...
                <View style={{flex:3, marginVertical:10}}>
                    <Shadow style={{width:'100%', height:'100%'}} distance={7} startColor={"#0ABAB5"} offset={[8,6]}>
                        <View style={styles.box}>
                            <View style={styles.boxhead}>
                                <Text style={styles.headerText}>ค่าใช้จ่ายออมและลงทุน</Text>
                            </View>
                            <View style={{flex:3}}>
                                <FlatList
                                    data={category3}
