...
export const CategoryExpensesSelectionScreen = ({navigation})=>{
    ...
    const [routes] = useState([
        { key: 'work', title: 'ค่าใช้จ่ายผันแปร' },
        { key: 'assets', title: 'ค่าใช้จ่ายคงที่' },
        { key: 'others', title: 'ค่าใช้จ่ายออมและลงทุน' },
    ]);
    ...
    const retrieveData = async () => {
        try {
            ...
            const items1 = categoryData.filter(item => item.category === "ค่าใช้จ่ายผันแปร");
            const items2 = categoryData.filter(item => item.category === "ค่าใช้จ่ายคงที่");
    ...
    return(
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={isEdit ? styles.titleEdit : styles.title}>ค่าใช้จ่าย</Text>
