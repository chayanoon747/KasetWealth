...
export const EnterNameScreen = ({navigation})=>{
    return(
       <SafeAreaView style={{flex:1, backgroundColor:'#2C6264'}}>
            ...
            <View  style={{flex: 10,justifyContent:'center',alignContent:'center',flexDirection:'row'}} >
            ...
            <View style={{flex: 10,justifyContent:'Top',alignContent:'Top',flexDirection:'column'}} > 
            ...
            <View  style={{flex: 10,justifyContent:'center',alignContent:'center',flexDirection:'row', borderWidth:1, borderColor:'#000000',backgroundColor:'#0ABAB5'}} >
                <View style={{flex:1, borderWidth:1, borderColor:'#000000', borderRadius:15, marginVertical:12,marginHorizontal : 5, backgroundColor:'#ffffff'}}>
                    <View style={{flex:1, flexDirection:'column', alignItems:'center', paddingHorizontal:10, paddingTop:1}}>
                        <Text style={{fontFamily:'ZenOldMincho-Regular', fontSize:24, color:'#000000',textAlign:'center', paddingTop:50}}>อยากตั้งชื่ออะไรดีละ!</Text> 
                        <View style={{borderWidth:1, borderColor:'#000000', borderRadius:15, marginVertical:12,marginHorizontal : 5, backgroundColor:'#ffffff'}}>
